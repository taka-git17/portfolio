...
// スライドショー
let setImage = [	
    "./one-page/images/page/mainvisual/mainvisual02.jpg",	
	"./one-page/images/page/mainvisual/mainvisual03.jpg",
    "./one-page/images/page/mainvisual/mainvisual01.jpg",
    "./one-page/images/page/mainvisual/mainvisual01.jpg"
  ];
  //カウンター初期値設定	
  let counter = 0;	
  //設定した画像パスをid="slideshow"のbackground-imageに設定、繰り返す	
  function slideimage(){	
...
ScrollReveal().reveal('.to-right-fadein', { 
	duration: 1600, 
	origin: 'left', 
	distance: '500px',
	reset: true   
});
ScrollReveal().reveal('.to-left-fadein', { 
	duration: 1600, 
	origin: 'right', 
	distance: '500px',
	reset: true   
  });
ScrollReveal().reveal('.to-center-fadein', { 
	duration: 1600, 
	scale: 0.1,
	reset: true
});
ScrollReveal().reveal('.center-fadein1', { 
	duration: 2100, 
	scale: 0.1,
	reset: true
});
ScrollReveal().reveal('.center-fadein2', { 
	duration: 2600, 
	scale: 0.1,
	reset: true
});
ScrollReveal().reveal('.center-fadein3', { 
	duration: 3100, 
	scale: 0.1,
	reset: true
});
ScrollReveal().reveal('.center-fadein4', { 
	duration: 3600, 
	scale: 0.1,
	reset: true
});
